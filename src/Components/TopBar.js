            ...
            <div className="container-fluid">
                ...
                <div className="container-fluid" >
                    ...
                    <span className="mr-2 d-none d-lg-inline text-gray-900"><img className="img-profile rounded-circle" style={{ width: 30 }}
                        src="https://cdn3.iconfinder.com/data/icons/3d-printing-icon-set/512/User.png" />Gunal N</span>
                    <div> 
                    <Link className="btn btn-outline-success btn-sm text-gray-900" to="/">Logout</Link>
                    </div>
